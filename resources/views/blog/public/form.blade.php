...
<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="image-preview preview-upload">
						 ...
						 >{{ $row['description'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Short Descripton" class=" control-label col-md-4 text-left"> Short Descripton </label>
										<div class="col-md-6">
										  <textarea name='short_descripton' rows='5' id='editor' class='form-control form-control-sm editor '  
						 >{{ $row['short_descripton'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#status").jCombo("{!! url('blog/comboselect?filter=status:id:title') !!}",
