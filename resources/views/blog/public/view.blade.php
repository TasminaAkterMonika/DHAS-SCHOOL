	...
	<div class="table-container" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Short Descripton', (isset($fields['short_descripton']['language'])? $fields['short_descripton']['language'] : array())) }}</td>
