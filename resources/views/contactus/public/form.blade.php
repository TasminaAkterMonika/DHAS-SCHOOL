...
<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Details(optional)" class=" control-label col-md-4 text-left"> Details(optional) </label>
										<div class="col-md-6">
										  <input  type='text' name='details(optional)' id='details(optional)' value='{{ $row['details(optional)'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
