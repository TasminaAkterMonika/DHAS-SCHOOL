	...
	<div class="table-container" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Info 1', (isset($fields['info_1']['language'])? $fields['info_1']['language'] : array())) }}</td>
						<td>{{ $row->info_1}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Info 2', (isset($fields['info_2']['language'])? $fields['info_2']['language'] : array())) }}</td>
						<td>{{ $row->info_2}} </td>
