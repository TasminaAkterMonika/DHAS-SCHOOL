              ...
              <div class="blog_box">
                <div class="row">
                 @foreach($events as $event)
                  <div class="col-lg-5">
                    <div class="blogImg"><img src="{{ asset('uploads')}}/images/event/{{ $event->image }}" alt="" style="width: 314px; padding:30px 0px">
                      <div class="time_box" style="padding: 8px 65px; bottom: 30px; right: 27px" ><span>{{$event->date}}</span></div>
                    </div>
                  </div>
                  <div class="col-lg-7">
                    <div class="path_box">
