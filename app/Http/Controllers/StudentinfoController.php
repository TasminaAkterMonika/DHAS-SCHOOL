...
class StudentinfoController extends Controller {
	...
	public $module = 'studentinfo';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Studentinfo();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'studentinfo',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('studentinfo');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('studentinfo.public.view',$data);			
			}			
		} 
		else {
			...
			return view('studentinfo.public.index',$data);	
		}
