...
class TeacherController extends Controller {
	...
	public $module = 'teacherdetails';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Teacherdetails();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'teacherdetails',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('teacherdetails');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('teacherdetails.public.view',$data);			
			}			
		} 
		else {
			...
			return view('teacherdetails.public.index',$data);	
		}
