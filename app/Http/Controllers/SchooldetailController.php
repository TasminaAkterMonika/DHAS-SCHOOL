...
class SchooldetailController extends Controller {
	...
	public $module = 'schooldetail';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Schooldetail();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'schooldetail',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('schooldetail');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('schooldetail.public.view',$data);			
			}			
		} 
		else {
			...
			return view('schooldetail.public.index',$data);	
		}
