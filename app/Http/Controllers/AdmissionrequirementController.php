...
class AdmissionrequirementController extends Controller {
	...
	public $module = 'admissionrequirement';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Admissionrequirement();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'admissionrequirement',
	...
	public static function display(  )
	{
		...
		$model  = new Admissionrequirement();
		$info = $model::makeInfo('admissionrequirement');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('admissionrequirement.public.view',$data);			
			}			
		} 
		else {
			...
			return view('admissionrequirement.public.index',$data);	
		}
