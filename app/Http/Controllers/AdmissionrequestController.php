...
class AdmissionrequestController extends Controller {
	...
	public $module = 'admissionrequest';
	static $per_page	= '50';
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('admissionrequest');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('admissionrequest.public.view',$data);			
			}			
		} 
		else {
			...
			return view('admissionrequest.public.index',$data);	
		}
