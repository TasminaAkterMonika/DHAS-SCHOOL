...
class StudentlistController extends Controller {
	...
	public $module = 'studentlist';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Studentlist();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'studentlist',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('studentlist');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('studentlist.public.view',$data);			
			}			
		} 
		else {
			...
			return view('studentlist.public.index',$data);	
		}
