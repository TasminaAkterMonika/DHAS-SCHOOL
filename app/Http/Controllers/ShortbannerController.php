...
class ShortbannerController extends Controller {
	...
	public $module = 'shortbanner';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Shortbanner();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'shortbanner',
	...
	public static function display(  )
	{
		...
		$model  = new Shortbanner();
		$info = $model::makeInfo('shortbanner');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('shortbanner.public.view',$data);			
			}			
		} 
		else {
			...
			return view('shortbanner.public.index',$data);	
		}
